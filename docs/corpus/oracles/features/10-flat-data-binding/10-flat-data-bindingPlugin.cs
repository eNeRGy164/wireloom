...
namespace CorpusFlatDataBinding
{
    ...
    namespace Implementation
    {
        ...
        public struct SampleUnmanaged : Rti.Dds.NativeInterface.TypePlugin.INativeTopicType<global::CorpusFlatDataBinding.Sample>
        {
            ...
            public void FromNative(global::CorpusFlatDataBinding.Sample sample, bool keysOnly = false)
            {
            ...
            public void ToNative(global::CorpusFlatDataBinding.Sample sample, bool keysOnly = false)
            {
                id = sample.id;
                value = sample.value;
            }
        ...
        internal class SamplePlugin : Rti.Dds.NativeInterface.TypePlugin.InterpretedTypePlugin<global::CorpusFlatDataBinding.Sample, SampleUnmanaged>
        {

            internal SamplePlugin() : base("global::CorpusFlatDataBinding.Sample", isKeyed: false, CreateDynamicType(isPublic: false))
            {
            }
            ...
            public static DynamicType CreateDynamicType(bool isPublic = true)
            {
                ...
                DynamicType result = tsf.CreateTypeWithAccessInfo<SampleUnmanaged>(
                    ...
                    .WithName("CorpusFlatDataBinding::Sample")
    ...
    public class SampleSupport : Rti.Dds.Topics.TypeSupport<global::CorpusFlatDataBinding.Sample>
    {
        ...
        ServiceEnvironment.Instance.Internal.TypeSupportFactory.CreateTypeSupport<SampleSupport, global::CorpusFlatDataBinding.Sample>();
