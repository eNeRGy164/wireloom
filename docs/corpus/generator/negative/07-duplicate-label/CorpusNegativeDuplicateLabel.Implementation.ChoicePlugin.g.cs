...
{
    internal ChoicePlugin() : base("CorpusNegativeDuplicateLabel.Choice", isKeyed: false, CreateDynamicType(isPublic: false))
    {
    }
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        {
            new UnionMember("first", dtf.GetPrimitiveType<int>(), new int[] { 1 }, id: 1),
            new UnionMember("second", dtf.GetPrimitiveType<int>(), new int[] { 1 }, id: 2)
        };
