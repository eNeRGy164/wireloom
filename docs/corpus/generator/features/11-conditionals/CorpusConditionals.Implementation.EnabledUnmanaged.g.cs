...
/// <summary>
/// Provides the RTI native representation for <see cref="Enabled"/>.
/// </summary>
public struct EnabledUnmanaged : INativeTopicType<Enabled>
{
    private int value;
    ...
    public void FromNative(Enabled sample, bool keysOnly = false)
    {
        sample.value = value;
    }
    ...
    /// <param name="keysOnly">Whether to copy only key members.</param>
    public void ToNative(Enabled sample, bool keysOnly = false)
    {
        value = sample.value;
    }
}
