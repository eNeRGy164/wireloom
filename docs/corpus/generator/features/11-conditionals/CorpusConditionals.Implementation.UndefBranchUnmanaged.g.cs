...
/// <summary>
/// Provides the RTI native representation for <see cref="UndefBranch"/>.
/// </summary>
public struct UndefBranchUnmanaged : INativeTopicType<UndefBranch>
{
    private int value;
    ...
    public void FromNative(UndefBranch sample, bool keysOnly = false)
    {
        sample.value = value;
    }
    ...
    /// <param name="keysOnly">Whether to copy only key members.</param>
    public void ToNative(UndefBranch sample, bool keysOnly = false)
    {
        value = sample.value;
    }
}
