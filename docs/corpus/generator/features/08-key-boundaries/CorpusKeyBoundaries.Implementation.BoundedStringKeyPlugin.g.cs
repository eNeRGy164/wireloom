...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="BoundedStringKey"/>.
/// </summary>
internal class BoundedStringKeyPlugin : InterpretedTypePlugin<BoundedStringKey, BoundedStringKeyUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="BoundedStringKey"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        {
            new StructMember("name", dtf.CreateString(12), isKey: true, id: 0),
            new StructMember("payload", dtf.GetPrimitiveType<int>(), id: 1)
        };

        var result = tsf.CreateTypeWithAccessInfo<BoundedStringKeyUnmanaged>(
            dtf.BuildStruct()
