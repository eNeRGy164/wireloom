...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="ArrayKey"/>.
/// </summary>
internal class ArrayKeyPlugin : InterpretedTypePlugin<ArrayKey, ArrayKeyUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="ArrayKey"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        var result = tsf.CreateTypeWithAccessInfo<ArrayKeyUnmanaged>(
            dtf.BuildStruct()
