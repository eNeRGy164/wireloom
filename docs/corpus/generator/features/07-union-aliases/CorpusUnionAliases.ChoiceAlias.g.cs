...
/// <summary>
/// Represents the <c>ChoiceAlias</c> IDL typedef declared in <c>07-union-aliases.idl</c>.
/// </summary>
public partial class ChoiceAlias : IEquatable<ChoiceAlias>
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override bool Equals(object? obj) => Equals(obj as ChoiceAlias);
