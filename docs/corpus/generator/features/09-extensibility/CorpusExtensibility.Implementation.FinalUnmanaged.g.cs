...
/// <summary>
/// Provides the RTI native representation for <see cref="Final"/>.
/// </summary>
public struct FinalUnmanaged : INativeTopicType<Final>
{
    private int id;
    ...
    /// <param name="keysOnly">Whether to copy only key members.</param>
    public void ToNative(Final sample, bool keysOnly = false)
    {
        id = sample.id;
