...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="Appendable"/>.
/// </summary>
internal class AppendablePlugin : InterpretedTypePlugin<Appendable, AppendableUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="Appendable"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        var result = tsf.CreateTypeWithAccessInfo<AppendableUnmanaged>(
            dtf.BuildStruct()
