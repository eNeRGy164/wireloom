...
/// <summary>
/// Provides the RTI native representation for <see cref="Reopened"/>.
/// </summary>
public struct ReopenedUnmanaged : INativeTopicType<Reopened>
{
    private KeywordRecordUnmanaged value;
