...
internal class LongSequencePlugin : InterpretedTypePlugin<LongSequence, LongSequenceUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="LongSequence"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        return tsf.CreateAliasWithAccessInfo<LongSequenceUnmanaged>(dtf, "LongSequence", tsf.CreateSequenceWithAccessInfo(dtf, dtf.GetPrimitiveType<int>(), 3));
    }
}
