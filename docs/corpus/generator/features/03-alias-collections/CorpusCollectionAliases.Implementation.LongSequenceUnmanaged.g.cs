...
public struct LongSequenceUnmanaged : INativeTopicType<LongSequence>
{
    ...
    public void FromNative(LongSequence sample, bool keysOnly = false)
    {
    ...
    {
        Value.Initialize<int>(max: 3, absoluteMax: 3, allocateMemory: allocateMemory);
    }
    ...
    /// <param name="keysOnly">Whether to copy only key members.</param>
    public void ToNative(LongSequence sample, bool keysOnly = false)
    {
