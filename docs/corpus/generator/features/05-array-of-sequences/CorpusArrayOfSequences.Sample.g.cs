...
public partial class Sample : IEquatable<Sample>
{
    ...
    /// <summary>
    /// Gets the <c>names</c> member. Its maximum number of elements is <c>3</c>.
    /// </summary>
    [Bound(3)]
    public ISequence<string> names { get; } = null!;
    ...
    public Sample(Sample? other)
    {
        ...
        names = new Sequence<string>(other.names);
    }
