...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="Base"/>.
/// </summary>
internal class BasePlugin : InterpretedTypePlugin<Base, BaseUnmanaged>
{
    internal BasePlugin() : base("CorpusAggregates.Base", isKeyed: false, CreateDynamicType(isPublic: false))
    {
    }

    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="Base"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        var result = tsf.CreateTypeWithAccessInfo<BaseUnmanaged>(
            dtf.BuildStruct()
