...
public struct BoundedLongsUnmanaged : INativeTopicType<BoundedLongs>
{
    ...
    public void FromNative(BoundedLongs sample, bool keysOnly = false)
    {
    ...
    /// <param name="keysOnly">Whether to copy only key members.</param>
    public void ToNative(BoundedLongs sample, bool keysOnly = false)
    {
