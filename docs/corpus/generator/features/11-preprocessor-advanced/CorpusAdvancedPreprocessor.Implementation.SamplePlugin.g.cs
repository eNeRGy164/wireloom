...
namespace CorpusAdvancedPreprocessor.Implementation;
...
{
    internal SamplePlugin() : base("CorpusAdvancedPreprocessor.Sample", isKeyed: false, CreateDynamicType(isPublic: false))
    {
    }
