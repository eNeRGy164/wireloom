...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="Context"/>.
/// </summary>
internal class ContextPlugin : InterpretedTypePlugin<Context, ContextUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="Context"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        var result = tsf.CreateTypeWithAccessInfo<ContextUnmanaged>(
            dtf.BuildStruct()
