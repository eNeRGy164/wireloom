...
public partial class Derived : Base, IEquatable<Derived>
{
    ...
    /// <summary>
    /// Gets or sets the <c>traceContext</c> member.
    /// </summary>
    public Context traceContext { get; set; } = new Context();
    ...
    public Derived(Derived? other) : base(other)
    {
        ...
        state = other.state;
        traceContext = new Context(other.traceContext);
    }
    ...
    public bool Equals(Derived? other)
    {
        ...
        return state.Equals(other.state)
            && traceContext.Equals(other.traceContext);
    }
