...
/// <summary>
/// Provides the RTI interpreted type plugin for <see cref="Item"/>.
/// </summary>
internal class ItemPlugin : InterpretedTypePlugin<Item, ItemUnmanaged>
{
    internal ItemPlugin() : base("CorpusIntegrationCollections.Item", isKeyed: false, CreateDynamicType(isPublic: false))
    {
    }

    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="Item"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        var result = tsf.CreateTypeWithAccessInfo<ItemUnmanaged>(
            dtf.BuildStruct()
