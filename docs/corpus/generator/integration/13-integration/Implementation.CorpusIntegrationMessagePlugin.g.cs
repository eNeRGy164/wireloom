...
internal class CorpusIntegrationMessagePlugin : InterpretedTypePlugin<CorpusIntegrationMessage, CorpusIntegrationMessageUnmanaged>
{
    ...
    /// <summary>
    /// Creates the RTI dynamic type description for <see cref="CorpusIntegrationMessage"/>.
    /// </summary>
    ...
    public static DynamicType CreateDynamicType(bool isPublic = true)
    {
        ...
        {
            new StructMember("text", dtf.CreateString(255), id: 0)
        };

        var result = tsf.CreateTypeWithAccessInfo<CorpusIntegrationMessageUnmanaged>(
            dtf.BuildStruct()
