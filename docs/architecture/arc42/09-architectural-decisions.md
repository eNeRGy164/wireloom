...
| Preserve observable RTI implementation quirks           | Makes the managed generator a drop-in replacement, even when oracle behavior is weak | Current; corpus oracles and chapter 8.6                |
